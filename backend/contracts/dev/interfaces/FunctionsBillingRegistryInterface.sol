...
interface FunctionsBillingRegistryInterface {
    struct RequestBilling {
        ...
        // The client contract that initialized the request to the DON
    ...
    /**
     * @notice Estimate the total cost to make a request: gas reimbursement, plus DON fee, plus Registry fee
     ...
     * @dev Only callable by a node that has been approved by the Registry
     */
    ...
    /**
     * @notice Gets the subscription owner
     * @param subscriptionId - ID of the subscription
     * @return owner - address of the subscription owner
     */
